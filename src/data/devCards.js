const devCards = [
  {
    iconSrc: '/assets/custom-dev.svg',
    iconAlt: 'Customised Development',
  ...
  {
    iconSrc: '/assets/integration-api.svg',
    iconAlt: 'Integration & API Management',
  ...
  {
    iconSrc: '/assets/cloud-native.svg',
  ...
  {
    iconSrc: '/assets/application-modernisation.svg',
    iconAlt: 'Application Modernisation',
